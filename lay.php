         ...
         if (isset($_SESSION['userid']) && ($_SESSION['userid'] !='')) {
           echo "<ul class=\"nav navbar-nav navbar-right loginonsignup\">".
                  "<li><a href=\"home.php?".'userid='.$_SESSION['userid'].
                    "\" class=\"active\"><span class=\"glyphicon glyphicon-home\"> home</a></li>".
                  "<li><a href=\"profile.php?".'userid='.$_SESSION['userid'].
                   "\"><span class=\"glyphicon glyphicon-user\"> My profile </a></li>".
                  "<li><a href=\"msg.php\"><span class=\"glyphicon glyphicon-envelope\"> msg</a></li>".
 ...
 function create_signin_form(){
  ?>
    ...
    <div class="container   ">
     ...
     <div class="row Signupbar  no-padding no-margin  ">
       <div class="col-xs-12 col-sm-offset-4 col-sm-3 signup-form-group ">
    ...
    <footer class="container-fluid ftfr  ">
      <div class="row  no-padding no-margin  ">
       <small class="col-xs-12 col-sm-4  ">
        <li>
        <a class="navbar-bkrand" href="#">&#169; 2013 MySchool | Privacy Policy</a>
       </li></small>
