  ...
  function create_header($title="sign up", $css_link="assets/stylesheets/MyschoolsignupCss.css"){
   ...
   <html lang="en">
    ...
    <!--  <script src="http://malsup.github.com/jquery.form.js"></script> -->
     ...
     <!-- ____________________________own created javascript  content="width=device-width, initial-scale=1_______________________________ -->
   ...
   <header class="container-fluid hdr   ">
     <div class="navbar-header hdrlogo ">
       <?php
         ...
         if ((strpos($_SERVER['PHP_SELF'], "index.php")) || (strpos($_SERVER['PHP_SELF'], "login.php")) ) { //we are on the index page
        ...
        <a class="navbar-brand  " href="index.php" id="logo">MySchool</a>
       <ul class="nav navbar-nav navbar-right visible-xs-inline-block">
         <?php
           //checking if we are on the sign up page or log in page in order to display the right text with icon
           if ((strpos($_SERVER['PHP_SELF'], "index.php"))) { //we are on the index page
             echo "<li><a href=\"views/login.php\">".
                   "<span class=\"glyphicon glyphicon-log-in\"></span> Login</a>".
                  "</li>"; //showing the login icon
            }elseif (strpos($_SERVER['PHP_SELF'], "login.php")) {//we are on the login page
  ...
  function create_header_menu(){
    ?>
     <?php
       if ((strpos($_SERVER['PHP_SELF'], "index.php"))) { //we are on the index page
         create_header_login();
        } elseif (strpos($_SERVER['PHP_SELF'], "login.php")) {
           ...
           echo "<ul class=\"nav navbar-nav navbar-right loginonsignup\">".
                  "<li>".
                   "<div class=\"row\">".
                     ...
                     "<span class=\"glyphicon glyphicon-th col-xs-1 \" id=\"menu-home\"></span>
                   </div>".
                   "<div class=\"row top-sub-menu\" id=\"all-home-menu\" style=\"display:nones;\">".
                     "<div class=\"col-xs-4  re\">".
                 ...
                 "<li>".
                   "<div class=\"row\">".
                     ...
                     "<span class=\"glyphicon glyphicon-th col-xs-1 \" id=\"menu-profile\"></span>
                   </div>".
                   "<div class=\"row top-sub-menu\" id=\"all-profile-menu\" style=\"display:nones;\">".
                     "<div class=\"col-xs-4 re\">".
                       "<a href=\"home.php?".'userid='.$_SESSION['userid']."\" class=\"glyphicon\">".
                        "<span class=\"glyphicon glyphicon-picture btfn-lg\"></span>".
                 ...
                 "<li>".
                   "<div class=\"row\">".
                     "<a href=\"profile.php?".'userid='.$_SESSION['userid'].
                   "\" id=\"menu-profile\"><span class=\"glyphicon glyphicon-user\"> My profile </a></li>".*/
                  "<li><a href=\"msg.php\" id=\"menu-msg\"><span class=\"glyphicon glyphicon-envelope\"> msg</a></li>".
                  "<li><a href=\"login.php\"><span class=\"glyphicon glyphicon-log-out\"> logout</a></li>".
               "</ul>";

           echo "<ul class=\"nav navbar-nav navbar-right loginonsignup\">".
                  "<li><a href=\"home.php?".'userid='.$_SESSION['userid'].
                    "\" class=\"active\"><span class=\"glyphicon glyphicon-home\"> Wanted</a></li>".
                  "<li><a href=\"profile.php?".'userid='.$_SESSION['userid'].
                   "\"><span class=\"glyphicon glyphicon-user\"> Notification </a></li>".
                  "<li><a href=\"msg.php\"><span class=\"glyphicon glyphicon-envelope\"> Partners</a></li>".
               " </ul>".
            /*"<ul class=\"nav navbar-nav navbar-right\">".
        "<li><a href=\"#\"><span class=\"glyphicon glyphicon-user\"></span> Sign Up</a></li>".
