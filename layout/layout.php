<?php
  ...
  function create_header($title="sign up", $css_link="assets/stylesheets/MyschoolsignupCss.css"){
   ...
   <html>
    ...
    <head> 
      ...
      <meta name="author" content="Alama Tounkara, Oumar Diarra">
  ...
  ?>
       <form  action="home.php" method="post">
         <input type="text" name="email" placeholder="Enter your username or email" id="toploginbox"/>
         <input type="password" name="pwd" placeholder="Enter password" id="toploginbox"/> 
         <label for="remember-user" id="remember-checkbox">
          <input type="checkbox" name="remember-user" />
          Remember me  &nbsp; <a href="#" id="forget-pawd"> Forgot password?</a>
         </label>
         
         <input type="submit" name="form-login" value="log in" class="login-button" />
       </form>
      </div>
    </header>
    <body>
  ...
  function create_header_menu(){
    ?>
       ///some mneu here 
     //leave the following at the end
 ...
 function create_signup_form() {
  ?>
    ...
    <div class="page">
     ...
     <form  action="home.php" method="post" id="signup-form">
        <label for="fname" class="signup-lbl">First Name:</label>
         <input type="text" name="fname" class="signup-boxes" /><br />

        <label for="lname" class="signup-lbl">last Name:</label>
         <input type="text" name="lname" class="signup-boxes" /><br />

       <label for="title" class="signup-lbl">Title:</label>
        <select name="title" class="signup-boxes" required>
        ...
        <label for="college" class="signup-lbl">Attending:</label>
        <select name="college" class="signup-boxes" >
        ...
        <label for="email" class="signup-lbl">Email:</label>
         <input type="text" name="email"  class="signup-boxes" /><br />

        <label for="password" class="signup-lbl">Password:</label>
         <input type="password" name="password" class="signup-boxes" /><br />

         <input type="radio" name="sex" id="male-box" value="male">
        <label for="male-box" class="sex-lbl">Male</label>
      
         <input type="radio" name="sex" id="female-box" value="female">
        <label for="female-box" class="sex-lbl">Female</label><br />
    
       <label for="dob" class="signup-lbl">DOB:</label>
       <select name="birthmonth" id="dob" >
       ...
       <input type="submit" name="sign-up-form" value="sign up" class="signup-button" />
      </form>
     <small>
       <p id="termandcondition"> By clicking sign up, you agree to our <a href="#">Terms & Conditions</a>
       </p> 
      </small>	

       <p id="existingstudent">
 ...
 function create_signin_form(){
      ...
      <div class="signupmenu">
       ...
       <form  action="home.php" method="post" id="signup-form">
         <label for="email" class="signup-lbl">Email:</label>
          ...
          <label for="pwd" class="signup-lbl">Password:</label>
            <input type="password" name="pwd" class="signup-boxes" /><br />

         <input type="submit" name="login" value="Log in" class="signup-button" />
        </form>

        <small>
          <p id="termandcondition"><a href="#">Forgot your password!</a>
         </p> 
        </small>  
  ...
  ?>
     ...
     <small id="">
      <a href="#">&#169; 2013 MySchool | Privacy Policy</a>
    </small>
