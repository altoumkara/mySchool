     ...
     if (isset($_POST['post_content']) && isset($_SESSION["valid_user"])) {
         ...
         if ($book_count >0){
             ...
             'bookEdNumb' => htmlspecialchars(mysql_real_escape_string(
                            trim($_POST['post_content']['book']['edNumb']))), 'bookpublisher' => htmlspecialchars(mysql_real_escape_string(
                            trim($_POST['post_content']['book']['bookpublisher']))),
            'booklanguage' => htmlspecialchars(mysql_real_escape_string(
                            trim($_POST['post_content']['book']['booklanguage']))),
            'bookprice'=>htmlspecialchars(mysql_real_escape_string(
             ...
             'bookEdNumb' => addslashes(htmlspecialchars(mysql_real_escape_string(
                            trim($_POST['post_content']['book']['edNumb'])))), 'bookpublisher' => addslashes(htmlspecialchars(mysql_real_escape_string(
                            trim($_POST['post_content']['book']['bookpublisher'])))),
             'booklanguage' => addslashes(htmlspecialchars(mysql_real_escape_string(
                            trim($_POST['post_content']['book']['booklanguage'])))),
             'bookprice'=>addslashes(htmlspecialchars(mysql_real_escape_string(
                            trim($_POST['post_content']['book']['bookprice'])))),
